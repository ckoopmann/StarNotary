...
it("lets 2 users exchange stars", async () => {
  ...
  let user1 = accounts[1];
  let starId1 = 7;
  let star1 = await instance.createStar("Star 1", starId1, { from: user1 });

  let user2 = accounts[2];
  let starId2 = 8;
  let star2 = await instance.createStar("Star 2", starId2, { from: user2 });
...
it("lookUptokenIdToStarInfo test", async () => {
  ...
  let user1 = accounts[1];
  let starId = 10;
  let starName = "Yet another great star";
  ...
  assert.equal(starName, returnedName);
});
